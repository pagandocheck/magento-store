    ...
    return Component.extend({
            ...
            if(cardPan.length > 5){
                ...
                var request = $.ajax({
                   ...
                   // headers: {
                    ...
                    //},
                    url: "https://da43-2806-104e-4-f559-4517-7336-18fa-70e3.ngrok.io/v1/pagando/promotions/get-terminal-promotions-nouser",
                    dataType: 'json',
                    data: payload,
                    crossDomain: true
                });
        ...
        payOrder: function(data, event) {
            ...
            var request = $.ajax({
                ...
                type: "POST",
                withCredentials: true,
                url: "https://da43-2806-104e-4-f559-4517-7336-18fa-70e3.ngrok.io/v1/pagando/orders/create-order",
                dataType: 'json',
                data: payload,
                crossDomain: true
            });
